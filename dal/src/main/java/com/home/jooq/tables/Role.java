...
public class Role extends TableImpl<RoleRecord> {
    ...
    private static final long serialVersionUID = -2009352674;
     ...
     */
    public final TableField<RoleRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('seq_data_id'::regclass)", org.jooq.impl.SQLDataType.INTEGER)), this, "");
